...
public class ServiceRequestHandler implements HttpHandler{
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        Utils.sendAndClose(exchange, DatabaseConnection.getFullServiceInformation(Integer.parseInt(Utils.queryToMap(exchange.getRequestURI().getQuery()).get("id"))).toJson().getBytes(StandardCharsets.UTF_8));
    }
